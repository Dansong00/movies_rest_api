...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.owner'
        db.add_column(u'moviestash_movie', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='movies', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.owner'
        db.delete_column(u'moviestash_movie', 'owner_id')
    ...
    models = {
        ...
        u'moviestash.movie': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'movies'", 'to': u"orm['auth.User']"}),
